...
import kmi.exchange.core.orderbook.OrdersBucketBaseTest;
...
import static kmi.exchange.core.orderbook.OrdersBucketBaseTest.IGNORE_CMD_CONSUMER;
...
public abstract class ITOrdersBucketBase {
    ...
    public void shouldMatchAllOrdersAndValidateEachStep() {
        ...
        for (int j = 0; j < 300; j++) {
            ...
            long totalVolume = bucket.match(toMatch, triggerOrder, triggerOrder, OrdersBucketBaseTest.IGNORE_CMD_CONSUMER);
        ...
        OrderCommand triggerOrder = OrderCommand.update(1238729387, UID_9, 1000);
        bucket.match(expectedVolume, triggerOrder, triggerOrder, OrdersBucketBaseTest.IGNORE_CMD_CONSUMER);
    ...
    public void perfFullCycle() {
        ...
        for (int j = 0; j < 50_000; j++) {
            ...
            long matchingTotalVol = bucket.match(toMatch, triggerOrd, triggerOrd, OrdersBucketBaseTest.IGNORE_CMD_CONSUMER);
